...
md`${container()}`
  ...
  main.variable(observer("buildvis")).define("buildvis", ["magnitudeChart","magDimension","magDimensionCount","d3","updateMarkers","depthChart","depthDimension","depthDimensionCount","timeChart","hourDimension","hourDimensionCount","dataset","dataTable","dateDimension","map","updateFilters","dc"], function(magnitudeChart,magDimension,magDimensionCount,d3,updateMarkers,depthChart,depthDimension,depthDimensionCount,timeChart,hourDimension,hourDimensionCount,dataset,dataTable,dateDimension,map,updateFilters,dc)
{
...
function updateFilters(e){
    let id = idGrouping.all()
    let visibleMarkers = new Array(id.lengh)
